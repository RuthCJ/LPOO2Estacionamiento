...
namespace Vistas
{
    ...
    public partial class RegistrarEntrada : Window
    {
        ...
        private void btnRegistrarEntrada_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (!camposVacios() && verificarDniCliente())
            {
                ...
                TrabajarSector.ModificarEstadoSector(codigoSector, estado);
            ...
            {
                MessageBox.Show("Cliente no registrado", "Registro Entrada", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        {
            Cliente ClienteBuscado = TrabajarCliente.TraerCliente(txtDniCliente.Text);
